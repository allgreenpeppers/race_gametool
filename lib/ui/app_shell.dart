...
class _AppShellState extends ConsumerState<AppShell> {
  ...
  Future<void> _showClearConfirmation(BuildContext context, LevelEditorNotifier notifier) async {
                          ...
                          SegmentedButton<BlockCategory>(
                            ...
                            segments: [
                              for (final c in [
                                ...
                                ButtonSegment(value: c, label: Text(categoryLabel(c))),
                            ],
                        ...
                        children: [
                          if (mode == AppMode.assetDefiner) ...[
                            ...
                            FilledButton.tonalIcon(
                              ...
                              label: Text(
                                assetState.activeImage == null ? 'Load Image' : 'Replace Image',
                              ),
                            ),
                ...
                children: [
                  NavigationRail(
                    ...
                    onDestinationSelected: (index) =>
                        ref.read(appModeProvider.notifier).select(AppMode.values[index]),
